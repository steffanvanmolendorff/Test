...
*/
  ...
  %Let aud = https://matls-auth.dev2.openbanking.xyz/as/token.oauth2;
...
/*%let redirect_uri=https://api.mit.openbanking.qa/ssa/agDnK4xiweAFpehzrX/71PB5S1sOvGERoRbXb8GoB;*/
...
Filename HDRS "C:\inetpub\wwwroot\sasweb\Data\Temp\HDRS_Token.json";
