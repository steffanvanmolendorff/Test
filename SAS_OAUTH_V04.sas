...
/*%let drive_scope=https://api.mit.openbanking.qa/scim/v2/OBAccountPaymentServiceProviders/;*/
%let drive_scope=ASPSPReadAccess TPPReadAccess AuthoritiesReadAccess;
