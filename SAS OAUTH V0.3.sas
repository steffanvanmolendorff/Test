...
%let code_given =4/KoDH4I1ZVJ7kbKEwGK74hsxJa1hcuY0fVpJqKZ_qnso;
...
*--- %Let Client_id = 865598563534-rrbeueevd6rmkl80u2o7r1st8o0mn55f.apps.googleusercontent.com ---;
Filename CID "H:\STV\Open Banking\SAS\Data\Perm\client_id.dat";
Data _Null_x;
	Length str $1024;
	Fid = Fopen("CID");
	Rc = Fread(fid);
...
Filename Sec "H:\STV\Open Banking\SAS\Data\Perm\secret.dat";
Data _Null_;
	Length str $1024;
	Fid = Fopen("Sec");
	Rc = Fread(fid);
