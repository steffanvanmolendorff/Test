...
/*
"softwareStatementId": "1CsWTO9X7j7pBNkR6cecht",
  "clientScopes": "ASPSPReadAccess TPPReadAll AuthoritiesReadAccess",
  "keyId": "GENbibHPa1cjlWKpXdtVriUhJ-g",
  "tokenUrl": "https://matls-auth.dev2.openbanking.xyz/as/token.oauth2",
  "tppTestUrl": "https://matls-obdssaapi.dev2.openbanking.xyz/api/v1rc2/aspsp/pEb7BQTOGUYACM5fhT/ssa/1CsWTO9X7j7pBNkR6cecht",
  "aud": "https://matls-auth.dev2.openbanking.xyz/as/token.oauth2"
*/
  %let tokenUrl = https://matls-auth.dev2.openbanking.xyz/as/token.oauth2;
  %Let softwareStatementId = 1CsWTO9X7j7pBNkR6cecht;
  %Let clientScopes = ASPSPReadAccess TPPReadAll AuthoritiesReadAccess;
  %Let keyId = GENbibHPa1cjlWKpXdtVriUhJ-g;
  %Let tppTestUrl = https://matls-obdssaapi.dev2.openbanking.xyz/api/v1rc2/aspsp/pEb7BQTOGUYACM5fhT/ssa/1CsWTO9X7j7pBNkR6cecht;
*--- OB TOken generated via Node.js ---;
  %Let OBToken = eyJhbGciOiJSUzUxMiIsImtpZCI6IjEifQ.eyJzY29wZSI6WyJBU1BTUFJlYWRBY2Nlc3MiLCJUUFBSZWFkQWxsIiwiQXV0aG9yaXRpZXNSZWFkQWNjZXNzIl0sImNsaWVudF9pZCI6IjFDc1dUTzlYN2o3cEJOa1I2Y2VjaHQiLCJleHAiOjE1MTk3MjQzNzF9.RwDq3hIta8Xf1BwBBNcvlHohX4FJiVaODRbTgS1ggE1sPZFP0tXpCdJtNSntIeOGDhoNf5JFZ1v8RTCyMherAt6WZum04Zu0v9XOW9ArNieRvOEw-pN7p9JF4r8bu0hjmheAG_5o8JDYuCGhLugRnkVvlldNfGLh12hyVGhsnlm9l2URkZ23SJl5gQH-A0pjthwNLpvB1yrgaBmQzhW1w1dLW4_RwE50HiMDuCrP747bUgF6OQCZMkNY0lbyxA2F7IuWjD5qbpeI0FvHO8Ayb0hssRfYs2tGSGlOIT4rYYs3cptMTivarnRJLKK-pJ1FDoaI3O_2PNukVXI57OMm1w;

	%Let url = &tokenUrl.?
				softwareStatementId=&softwareStatementId.
				clientScopes=&clientScopes.
				keyId=&keyId.
				tppTestUrl=&tppTestUrl.
				OBToken=&OBToken;
...
%let drive_scope=https://matls-obdssaapi.dev2.openbanking.xyz/api/v1rc2/aspsp/pEb7BQTOGUYACM5fhT/ssa/1CsWTO9X7j7pBNkR6cecht;
...
/*Filename Token "C:\inetpub\wwwroot\sasweb\Data\Perm\Token\OBToken.txt";*/
%Let OBToken = eyJhbGciOiJSUzUxMiIsImtpZCI6IjEifQ.eyJzY29wZSI6WyJBU1BTUFJlYWRBY2Nlc3MiLCJUUFBSZWFkQWxsIiwiQXV0aG9yaXRpZXNSZWFkQWNjZXNzIl0sImNsaWVudF9pZCI6IjFDc1dUTzlYN2o3cEJOa1I2Y2VjaHQiLCJleHAiOjE1MTk3MjQzNzF9.RwDq3hIta8Xf1BwBBNcvlHohX4FJiVaODRbTgS1ggE1sPZFP0tXpCdJtNSntIeOGDhoNf5JFZ1v8RTCyMherAt6WZum04Zu0v9XOW9ArNieRvOEw-pN7p9JF4r8bu0hjmheAG_5o8JDYuCGhLugRnkVvlldNfGLh12hyVGhsnlm9l2URkZ23SJl5gQH-A0pjthwNLpvB1yrgaBmQzhW1w1dLW4_RwE50HiMDuCrP747bUgF6OQCZMkNY0lbyxA2F7IuWjD5qbpeI0FvHO8Ayb0hssRfYs2tGSGlOIT4rYYs3cptMTivarnRJLKK-pJ1FDoaI3O_2PNukVXI57OMm1w;
...
%let url=&auth_url.OBT/*?client_id=&client_id.%nrstr(&redirect_uri)=&redirect_uri.%nrstr(&response_type=code&scope=openid%20email)%20&drive_scope.&state=security_token)*/;
*--- Create a Temporary File name to store the Location value as received from the Google Analytics OAUTH2 instance ---;
Filename Token Temp;
*--- Submit the URL values to the Google Analytics server to request the location Token ---;
Proc HTTP
...
%let code_given =4/MxkF7_f8WsQyntEB6ZZIvFC6AqeTVRW7S0QnVOa6SAs;
