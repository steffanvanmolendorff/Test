...
Data OBData.&Dsn(Drop = Hierarchy Position Want Rename=(Hierarchy1 = Hierarchy));
	Length Table $ 16 Pattern Hierarchy Hierarchy1 Position Want $ 250;
	Set OBData.&Dsn;
	If XPath NE '';
	Table = "&Dsn";
...
Data OBData.Compare(Keep = Hierarchy Table MinLength MaxLength type Class 
	Infile ClassLength EnhancedDefinition Description Desc_Flag UML_MaxLength UML_MinLength
	Min_Length_Flag Max_Length_Flag);

	Length XPath $ 100 Codes $ 30 NewPath $ 70;
